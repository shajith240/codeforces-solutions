 ...
 * Hint 3: Binary‑search the second list (sorted by start ) to split rides into those with start and those with start > finish1 . Use the prefix minimum duration on the early group to get an earliest finish of finish1 + minDuration and the suffix minimum finish time on the late group.
