 ...
 * For each index i, find the maximum number of indices j such that j i and |a_i - k| |a_j - k|, over all possible integer values of k.
 *
 * ── Input ────────────────────────────────────────────────
 ...
 * • For i=2, you can choose k=5, there exists no index j i. In the third test, the answers are:
 * 
 ...
 * • For i=5, you can choose k=998\,244\,353, there exists no index j i.
 *
 */
